...
fetchAndInsert(`${baseURL}/tools/_includes/header.html`, 'header-container');
...
fetchAndInsert(`${baseURL}/tools/${currentPage}`, 'page-content-container');

// Fetch and insert footer
fetchAndInsert(`${baseURL}/tools/_includes/footer.html`, 'footer-container');
